      ...
      final ImageSource? source = await showDialog<ImageSource>(
        ...
        builder: (context) => AlertDialog(
          ...
          content: Column(
            ...
            children: [
              ListTile(
                leading: Icon(Icons.camera_alt, color: _appTheme.brandRed),
                title: Text('Camera'),
                onTap: () => Navigator.pop(context, ImageSource.camera),
              ),
              ListTile(
                leading: Icon(Icons.photo_library, color: _appTheme.brandRed),
                title: Text('Gallery'),
                    ...
                    child: Column(
                      ...
                      TextFormField(
                        ...
                        decoration: InputDecoration(
                          ...
                          prefixIcon: Icon(Icons.person_outline, color: _appTheme.brandRed),
                      ...
                      TextFormField(
                        ...
                        decoration: InputDecoration(
                          labelText: 'Email *',
                          prefixIcon: Icon(Icons.email_outlined, color: _appTheme.brandRed),
                          border: OutlineInputBorder(
                            borderRadius: BorderRadius.circular(12),
                          ),
                          enabledBorder: OutlineInputBorder(
