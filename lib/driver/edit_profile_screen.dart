...
class _EditProfileScreenState extends State<EditProfileScreen> {
  ...
  // Controllers
  final TextEditingController _nameController = TextEditingController(text: 'Sri Akshay');
                  ...
                  children: [
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        border: Border.all(
                          color: _profilePictureChanged ? Colors.orange : _appTheme.brandRed,
                          width: 3,
                        ),
                      ),
                      child: Icon(
  ...
  Widget _buildTextField({
    ...
    return TextFormField(
      ...
      decoration: InputDecoration(
        ...
        prefixIcon: Icon(
          icon,
          color: enabled ? _appTheme.brandRed : _appTheme.textGrey,
