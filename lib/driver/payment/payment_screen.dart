              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildPaymentMethodCard(
                    ...
                    imagePath: 'assets/google-pay.png',
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Row(
          children: [
            Container(
              width: Responsive.iconSize(context, 52),
              height: Responsive.iconSize(context, 52),
              padding: EdgeInsets.all(Responsive.padding(context, imagePath != null ? 8 : 12)),
              decoration: BoxDecoration(
                color: imagePath != null ? Colors.white : color.withOpacity(0.1),
                borderRadius: BorderRadius.circular(10),
                border: imagePath != null ? Border.all(color: Colors.grey.shade200) : null,
              ),
